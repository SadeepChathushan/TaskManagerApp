            ...
            <form @submit.prevent="loginAction">
              <div class="mb-3">
                ...
                <input
                  ...
                  id="email"
                  :class="{
                    'is-invalid': validationErrors.email || emailError,
                  }"
                />
              ...
              <div class="mb-3">
                ...
                <input
                  ...
                  id="password"
                  :class="{
                    'is-invalid': validationErrors.password || passwordError,
                  }"
                />
  ...
  methods: {
    async loginAction() {
      if (this.validateInputs()) {
        ...
        this.validationErrors.general = error.response.data.message || "Invalid credentials!";
      } else {
        this.validationErrors.general = "An unexpected error occurred. Please try again.";
      }        }
      }
    },
    validateInputs() {
